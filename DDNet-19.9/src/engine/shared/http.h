...
/**
 * Route all subsequent HTTP requests through a SOCKS5 proxy (remote DNS).
 * Pass nullptr to disable and go direct. The proxy address is given in curl
 * format "host:port" (e.g. "127.0.0.1:10801"). Thread-safe.
 *
